                            ...
                            <form class="edit-form">
                                                ...
                                                <h6 class="mb-4">Contact details</h6>
                                                    ...
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="text" class="form-control "
                                                            placeholder="A business or person's name" name='name'>
                                                    </div>
                                                    <div class="form-group mb-4">
                                                    ...
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" aria-label="First name" class="form-control"
                                                                placeholder="Country" name='phone_country'>
                                                            <input type="text" aria-label="Last name" class="form-control"
                                                                placeholder="Area" name='phone_area'>
                                                            <input type="text" aria-label="Last name" class="form-control"
                                                                placeholder="Number" name='phone_number'>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="text" class="form-control "
                                                            placeholder="e.g. A business or person's name" name='bank_acc_name'>
                                                    ...
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="e.g. 123456789" name='bank_acc_num'>
                                                    ...
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="text" class="form-control "
                                                            placeholder="e.g. 123456789" name='tax_id_num'>
                                                    ...
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <select id="slide" class="form-control" name='currency'>
                                ...
                                <div class="card-footer">
                                    <div class="action d-flex justify-content-end">
                                        ...
                                        <button type='button' class="btn btn-primary submit-btn">Save & close</button>
                                    </div>
                                </div>
                            </form>
                        </div>
