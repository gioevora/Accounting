        ...
        <li class="nav-list">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="/business/items">Products and services</a></li>
        ...
        <li class="nav-list">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="/accounting/accounts">Chart of accounts</a></li>
            ...
            <li class="dropdown-list">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="#">Recieve Money</a></li>
                        <li><a class="dropdown-item" href="#">Transfer Money</a></li>
                    </ul>
                </div>
            </li>
            <li class="dropdown-list"><i class="fa-solid fa-magnifying-glass"></i></li>
