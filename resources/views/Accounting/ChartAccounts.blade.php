...
@section('content')
    ...
    <main>
        ...
        <div class="modal fade new-account-modal" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal fade edit-account-modal" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
